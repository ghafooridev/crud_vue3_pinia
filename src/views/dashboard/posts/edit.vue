  ...
  <div class="card w-full bg-base-100 shadow-xl">
    <div class="card-body">
      <div class="flex justify-between">
        <div>
          <h2 class="text-md uppercase text-primary font-bold">Edit Article</h2>
          <p class="text-sm font-light">Edit Article Form</p>
        </div>
        <div>
          <RouterLink
            :to="{ name: 'posts.index' }"
      ...
      <form @submit.prevent="onUpdate" enctype="multipart/form-data">
        ...
        <div class="form-control">
          ...
          <select
            ...
            :disabled="loading"
          >
          <option disabled selected>Select Publication Status</option>
